...
export default function AddContact({ user }) {
  ...
  return (
    <form
      ...
      className={`flex flex-col max-w-screen-lg mx-auto mb-8 space-y-3 pt-2 px-2 ${
        openAddContact && "border rounded-md p-2 shadow-sm pb-4"
      } `}
    >
      ...
      <svg
        ...
        className={`transform duration-300 text-gray-500 ${
